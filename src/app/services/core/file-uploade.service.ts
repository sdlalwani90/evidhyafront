...
import { HttpClient, HttpErrorResponse, HttpRequest, HttpResponse, HttpHeaders } from '@angular/common/http';
...
export class FileUploadeService {
    ...
    public url: string = 'http://localhost:8000/api/uploadmou/1';

    private _queue: BehaviorSubject<FileQueueObject[]>;
    private _files: FileQueueObject[] = [];

    constructor(private http: HttpClient, private restfull: RestfullApiService) {
    ...
    private _upload(queueObj: FileQueueObject) {
        ...
        let headers = new HttpHeaders({ 'Authorization': 'Bearer ' + token, 'X-Requested-With': 'XMLHttpRequest' });
